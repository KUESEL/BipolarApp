...
public class PostLightRequest implements Response.ErrorListener, Response.Listener<JSONObject> {
    ...
    public JsonObjectRequest createRequest(int userId, Object tag) throws JSONException {
        ...
        JsonObjectRequest ret = new JsonObjectRequest(Request.Method.POST, StaticValue.uploadLightUrl(userId), obj, this, this);
        ret.setTag(tag);
        return ret;
    }
